...
- **Explanatory Comments:** Comments should explain *why* a complex decision was made, not *what* the code is doing (which should be obvious from the strong typings and naming conventions).
