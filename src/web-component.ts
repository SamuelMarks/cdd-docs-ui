...
export class CDDApiDocs extends HTMLElement {
     ...
     * When receiving snippets generated by 'to_docs_json', it unrolls the 'endpoints' map into flat CodeExample entries.
     * It preserves the 'language' attribute of the wrapper CodeExample.
